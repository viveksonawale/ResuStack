    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute -top-[20%] -right-[10%] w-[50%] h-[50%] bg-gradient-to-br from-vercel-orange-500/20 to-vercel-amber-500/20 rounded-full blur-[120px]" />
                <div className="absolute -bottom-[20%] -left-[10%] w-[50%] h-[50%] bg-gradient-to-tr from-vercel-orange-500/10 to-vercel-amber-500/10 rounded-full blur-[120px]" />
            </div>
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h3 className="text-2xl font-bold text-white mt-6">Welcome Back</h3>
                ...
                <div className="bg-zinc-950/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center justify-end">
                            <Link href="#" className="text-sm text-vercel-orange-500 hover:text-vercel-orange-400 font-medium transition-colors">
                                Forgot password?
                            </Link>
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-vercel-orange-400 to-vercel-orange-500 hover:from-vercel-orange-500 hover:to-vercel-orange-600 text-white font-bold rounded-xl shadow-lg shadow-vercel-orange-500/20 active:scale-95 transition-all"
                        >
                            Sign In
                    ...
                    <div className="mt-6 pt-6 border-t border-white/5 text-center">
                        <p className="text-zinc-400 text-sm">
                            ...
                            <Link href="/signup" className="text-white font-bold hover:text-vercel-orange-500 transition-colors inline-flex items-center gap-1 group">
                                Sign Up
